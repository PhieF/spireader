...
JavaClass AndroidUtil::Class_ZLibrary("org/spireader/zlibrary/core/library/ZLibrary");
JavaClass AndroidUtil::Class_ZLFile("org/spireader/zlibrary/core/filesystem/ZLFile");
JavaClass AndroidUtil::Class_FileInfo("org/spireader/zlibrary/core/fonts/FileInfo");
JavaClass AndroidUtil::Class_FileEncryptionInfo("org/spireader/zlibrary/core/drm/FileEncryptionInfo");
JavaClass AndroidUtil::Class_ZLFileImage("org/spireader/zlibrary/core/image/ZLFileImage");
JavaClass AndroidUtil::Class_ZLTextModel("org/spireader/zlibrary/text/model/ZLTextModel");

JavaClass AndroidUtil::Class_Encoding("org/spireader/zlibrary/core/encodings/Encoding");
JavaClass AndroidUtil::Class_EncodingConverter("org/spireader/zlibrary/core/encodings/EncodingConverter");
JavaClass AndroidUtil::Class_JavaEncodingCollection("org/spireader/zlibrary/core/encodings/JavaEncodingCollection");

JavaClass AndroidUtil::Class_NativeFormatPlugin("org/spireader/fbreader/formats/NativeFormatPlugin");
JavaClass AndroidUtil::Class_PluginCollection("org/spireader/fbreader/formats/PluginCollection");
JavaClass AndroidUtil::Class_Paths("org/spireader/fbreader/Paths");
JavaClass AndroidUtil::Class_AbstractBook("org/spireader/fbreader/book/AbstractBook");
JavaClass AndroidUtil::Class_Book("org/spireader/fbreader/book/Book");
JavaClass AndroidUtil::Class_Tag("org/spireader/fbreader/book/Tag");
JavaClass AndroidUtil::Class_BookModel("org/spireader/fbreader/bookmodel/BookModel");
...
bool AndroidUtil::init(JavaVM* jvm) {
	...
	StaticMethod_NativeFormatPlugin_create = new StaticObjectMethod(Class_NativeFormatPlugin, "create", Class_NativeFormatPlugin, "(Lorg/spireader/zlibrary/core/util/SystemInfo;Ljava/lang/String;)");
	...
	Constructor_FileInfo = new Constructor(Class_FileInfo, "(Ljava/lang/String;Lorg/spireader/zlibrary/core/drm/FileEncryptionInfo;)V");
	...
	Constructor_ZLFileImage = new Constructor(Class_ZLFileImage, "(Lorg/spireader/zlibrary/core/filesystem/ZLFile;Ljava/lang/String;[I[ILorg/spireader/zlibrary/core/drm/FileEncryptionInfo;)V");
	...
	Method_Book_addTag = new VoidMethod(Class_AbstractBook, "addTag", "(Lorg/spireader/fbreader/book/Tag;)");
	Method_Book_addUid = new VoidMethod(Class_AbstractBook, "addUid", "(Ljava/lang/String;Ljava/lang/String;)");

	StaticMethod_Tag_getTag = new StaticObjectMethod(Class_Tag, "getTag", Class_Tag, "(Lorg/spireader/fbreader/book/Tag;Ljava/lang/String;)");
	...
	Method_BookModel_setBookTextModel = new VoidMethod(Class_BookModel, "setBookTextModel", "(Lorg/spireader/zlibrary/text/model/ZLTextModel;)");
	Method_BookModel_setFootnoteModel = new VoidMethod(Class_BookModel, "setFootnoteModel", "(Lorg/spireader/zlibrary/text/model/ZLTextModel;)");
	Method_BookModel_addImage = new VoidMethod(Class_BookModel, "addImage", "(Ljava/lang/String;Lorg/spireader/zlibrary/core/image/ZLImage;)");
	Method_BookModel_registerFontFamilyList = new VoidMethod(Class_BookModel, "registerFontFamilyList", "([Ljava/lang/String;)");
	Method_BookModel_registerFontEntry = new VoidMethod(Class_BookModel, "registerFontEntry", "(Ljava/lang/String;Lorg/spireader/zlibrary/core/fonts/FileInfo;Lorg/spireader/zlibrary/core/fonts/FileInfo;Lorg/spireader/zlibrary/core/fonts/FileInfo;Lorg/spireader/zlibrary/core/fonts/FileInfo;)");
